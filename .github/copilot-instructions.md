...
Este projeto segue o padrão **Conventional Commits** para manter um histórico de commits limpo e organizado.

### Exemplos de Conventional Commits

- `feat: adicionar seção de próximas tarefas na página inicial`
- `fix: corrigir formatação de datas de entrega`
- `docs: atualizar instruções de estrutura do projeto`
- `style: padronizar espaçamento no CSS`
- `refactor: reorganizar funções de carregamento de tarefas`
- `test: adicionar testes para validação de datas`
